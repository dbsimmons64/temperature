...
var UserChangedFarenheit = class extends CustomType {
  constructor($0) {
    super();
    this[0] = $0;
  }
};
var UserChangedCelcius = class extends CustomType {
  constructor($0) {
    super();
    this[0] = $0;
  }
...
function string_to_float(number) {
  let $ = parse_int(number);
  if ($ instanceof Ok) {
    let i = $[0];
    return new Ok(identity(i));
  } else {
    let $1 = parse_float(number);
    if ($1 instanceof Ok) {
      return $1;
    } else {
      return new Error(void 0);
  ...
  return div(
    ...
    toList([
      div(
        ...
        toList([
          h2(
            toList([class$("text-2xl font-medium mb-6")]),
            toList([text3("Fahrenheit to Celsius")])
          ),
          div(
            toList([class$("w-full flex flex-col gap-4")]),
            toList([
              div(
                ...
                toList([
                  label(
                    ...
                    toList([text3(" Fahrenheit ")])
                  ),
                  input(
                    toList([
                      placeholder("Enter \xB0F"),
                      class$(
